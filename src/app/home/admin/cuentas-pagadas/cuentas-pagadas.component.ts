...
@Component({
  selector: 'app-cuentas-pagadas',
  templateUrl: './cuentas-pagadas.component.html',
  styleUrls: ['./cuentas-pagadas.component.css']
})
export class CuentasPagadasComponent implements OnInit {
